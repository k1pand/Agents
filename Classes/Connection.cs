...
namespace Agents.Classes
{
    class Connection
    {
      ...
      //public static string String { get; } = "Data Source = DESKTOP-CB4OEUM; Initial Catalog = Agents; uid=; pwd=; Integrated Security = true";  //подключение к БД через вызов Connection
